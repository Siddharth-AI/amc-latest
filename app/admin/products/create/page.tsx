...
export default function CreateProductPage() {
  ...
  const addKeyFeatureToList = () => {
    ...
    setKeyFeatures([
      ...keyFeatures,
      { id: Date.now().toString(), name: newFeature },
    ]);
    setNewFeature("");
  };
  ...
  const addSpecificationToList = () => {
    ...
    setSpecifications([
      ...specifications,
      { id: Date.now().toString(), key: newSpecKey, value: newSpecValue },
    ]);
    setNewSpecKey("");
    setNewSpecValue("");
  };
  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    try {
      ...
      if (imageFiles.length > 0) {
        ...
        await dispatch(
          uploadProductImages({ id: productId, formData }),
        ).unwrap();
      }
      ...
      if (keyFeatures.length > 0) {
        ...
        for (const feature of keyFeatures) {
          await dispatch(
            addKeyFeature({ productId, data: { name: feature.name } }),
          ).unwrap();
        }
      }
      ...
      <div>
        <div className="mb-4 sm:mb-6">
          ...
          <p className="text-xs sm:text-sm lg:text-base text-gray-600">
            Add a new product with images, features, and specifications
          </p>
        </div>
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(), addKeyFeatureToList())
                  }
                />
                <Button
                  type="button"
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(), addSpecificationToList())
                  }
                />
                <Button
                  type="button"
