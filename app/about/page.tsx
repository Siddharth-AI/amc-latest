...
export default async function AboutPage() {
  ...
  const structuredData = generateWebPageSchema({
    title: "About Us - AMC Systems",
    description: "Learn about AMC Systems' 20+ year journey in providing cutting-edge POS solutions across the UAE.",
    url: aboutUrl,
    breadcrumbs,
  });
  ...
  <Container>
    <div className="max-w-4xl mx-auto sm:text-center px-4">
      ...
      <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-8 sm:mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed px-2">
        Over two decades of excellence, helping 1000+ businesses transform with cutting-edge point-of-sale technology
      </p>
      ...
      <div className="flex flex-col xs:flex-row flex-wrap md:justify-center gap-4 sm:gap-6 md:gap-8 sm:text-center px-2">
        <div className="flex items-center md:justify-center gap-2">
          ...
          <span className="text-xs sm:text-sm font-medium text-white whitespace-nowrap">ISO Certified</span>
        </div>
        <div className="flex items-center md:justify-center gap-2">
          <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 flex-shrink-0" />
        ...
        <div className="flex items-center md:justify-center gap-2">
          <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 flex-shrink-0" />
          <span className="text-xs sm:text-sm font-medium text-white whitespace-nowrap">1000+ Happy Clients</span>
        </div>
      </div>
    </div>
  </Container>
