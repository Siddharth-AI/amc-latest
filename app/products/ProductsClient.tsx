...
export default function ProductsClient() {
  ...
  const { categories, isLoading, error, pagination } = useAppSelector(
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            {isLoading ? (
              ...
              <ErrorMessage
                ...
                onRetry={() =>
                  dispatch(
                    fetchPublicCategories({ page: currentPage, limit: 12 }),
                  )
                }
              />
              ...
              {[
                {
                  ...
                  description:
                    "Cutting-edge POS solutions powered by modern technology",
                },
                {
                  icon: "🛡️",
                ...
                },
                {
                  ...
                  description:
                    "Top-tier products from leading global manufacturers",
                },
                {
                  icon: "🎯",
                ...
                },
                {
                  ...
                  description:
                    "24/7 technical assistance from certified professionals",
                },
                {
                  icon: "⚡",
        ...
        <Container className="relative z-10">
          <div className="max-w-3xl mx-auto text-center px-4">
            ...
            <p className="text-base sm:text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Get in touch with our experts to find the perfect solution for
              your needs
            </p>
